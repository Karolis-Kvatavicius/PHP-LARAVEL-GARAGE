...
<form action="{{isset($truck) ? route('truck.edit', $truck -> id) : route('truck.save')}}" method="post">
    ...
    <input type="text" name="truck_maker" value="{{isset($truck) ? $truck->maker : ''}}"><br><br>
    </div>
    <div class="field">
    <label for="truck_plate">Licence plate</label><br>
    <input type="text" name="truck_plate" value="{{isset($truck) ? $truck->plate : ''}}"><br><br>
    </div>
    <div class="field">
    <label for="truck_make_year">Make year</label><br>
    <input type="text" name="truck_make_year" value="{{isset($truck) ? $truck->make_year : ''}}"><br><br>
    </div>
    <div class="field">
    ...
    <textarea name="truck_mech_notices" id="" cols="150" rows="20">{{isset($truck) ? $truck->mechanic_notices : ''}}</textarea><br><br>
